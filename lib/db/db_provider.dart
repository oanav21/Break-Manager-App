...
class DBProvider {
  ...
  var todos = [
    Todo("Flutter database", parent: '1',),
    Todo("Navigation", parent: '1',),
    Todo("Basics", parent: '1', isCompleted: 1),
    Todo("BloC Model", parent: '2',),
    Todo("Dart for web", parent: '2',),
    Todo("Dart for mobile", parent: '2',),
  ];

  var tasks = [
    Task('Learn Flutter', id: '1',  color: Colors.purple.value, codePoint: Icons.phone_android.codePoint),
    Task('Dart', id: '2', color: Colors.pink.value, codePoint: Icons.laptop_mac.codePoint),
    Task('Mobile Development', id: '3', color: Colors.pink.value, codePoint: Icons.android.codePoint),
  ];
